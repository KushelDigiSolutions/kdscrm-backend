...
CREATE TABLE IF NOT EXISTS asset (
    ...
    allocated_to VARCHAR(36),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_asset_org FOREIGN KEY (organizationId) REFERENCES organizations(id) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_asset_user FOREIGN KEY (allocated_to) REFERENCES users(id) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS asset_transactions (
    ...
    handed_over_to VARCHAR(36) DEFAULT NULL,
    return_condition ENUM('Good', 'Average', 'Bad') DEFAULT NULL,
    deallocation_description TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    organizationId VARCHAR(36),
    CONSTRAINT fk_asset_txn_employee FOREIGN KEY (employee_id) REFERENCES users(id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_asset_txn_asset FOREIGN KEY (asset_id) REFERENCES asset(id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_asset_txn_handover FOREIGN KEY (handed_over_to) REFERENCES users(id) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_asset_txn_org FOREIGN KEY (organizationId) REFERENCES organizations(id) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE users
ADD COLUMN show_all_lead BOOLEAN DEFAULT FALSE AFTER password;